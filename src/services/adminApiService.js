...
export const adminApiService = {
  ...
  /**
   * Get all apartment assignments
   * @returns {Promise<Object>} API response
   */
  async getApartmentAssignments() {
    try {
      const response = await api.get("/tenants/assignments");
      return {
        success: true,
        data: response.data.data || []
      };
    } catch (error) {
      console.error("Error fetching apartment assignments:", error);
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch apartment assignments",
        data: []
      };
    }
  },
  ...
  async getFinancialTransactions(params = {}) {
    try {
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch financial transactions",
        data: []
      };
    }
  },
  ...
  async getFinancialTransaction(transactionId) {
    try {
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch financial transaction",
        data: {}
      };
    }
  },
  ...
  async createFinancialTransaction(transactionData) {
    try {
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to create financial transaction"
      };
    }
  },
   ...
   * @returns {Promise<Object>} API response
   */
  async updateFinancialTransaction(transactionId, updateData) {
    try {
      const response = await api.put(`/financial/transactions/${transactionId}`, updateData);
      return {
        success: true,
        data: response.data.data || {},
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to update financial transaction"
      };
    }
  },
  ...
  async deleteFinancialTransaction(transactionId) {
    try {
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to delete financial transaction"
      };
    }
  },
  ...
  async processRentPayment(paymentData) {
    try {
      const response = await api.post("/financial/transactions/rent-payment", paymentData);
      return {
        success: true,
        data: response.data.data || {},
        message: response.data.message || "Rent payment processed successfully"
      };
    } catch (error) {
      console.error("Error processing rent payment:", error);
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to process rent payment"
      };
    }
  },
   ...
   * @returns {Promise<Object>} API response
   */
  async getFinancialTransactionStatistics(params = {}) {
    try {
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch transaction statistics",
        data: {}
      };
    }
  },
  ...
  /**
   * Get tenant payment history (Enhanced)
   * @param {number} tenantId - Tenant ID
   * @param {Object} params - Query parameters
   * @returns {Promise<Object>} API response
   */
  async getTenantPaymentHistory(tenantId, params = {}) {
    try {
      const response = await api.get(`/financial/transactions/tenant/${tenantId}/history`, { params });
      return {
        success: true,
        data: response.data.data || {}
      };
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch tenant payment history",
        data: {}
      };
    }
  },
  ...
  /**
   * Get apartment payment history (Enhanced)
   * @param {number} apartmentId - Apartment ID
   * @param {Object} params - Query parameters
   * @returns {Promise<Object>} API response
   */
  async getApartmentPaymentHistory(apartmentId, params = {}) {
    try {
      const response = await api.get(`/financial/transactions/apartment/${apartmentId}/history`, { params });
      return {
        success: true,
        data: response.data.data || {}
      };
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch apartment payment history",
        data: {}
      };
    }
  },
  ...
  async getPaymentSchedules(params = {}) {
    try {
      const response = await api.get("/financial/payment-schedules", { params });
      return {
        success: true,
        data: response.data.data || [],
        count: response.data.count || 0
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch payment schedules",
        data: []
      };
    }
  },
  ...
  /**
   * Get single payment schedule
   * @param {number} scheduleId - Schedule ID
   * @returns {Promise<Object>} API response
   */
  async getPaymentSchedule(scheduleId) {
    try {
      const response = await api.get(`/financial/payment-schedules/${scheduleId}`);
      return {
        success: true,
        data: response.data.data || {}
      };
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch payment schedule",
        data: {}
      };
    }
  },
  ...
  async createPaymentSchedule(scheduleData) {
    try {
      const response = await api.post("/financial/payment-schedules", scheduleData);
      return {
        success: true,
        data: response.data.data || {},
        message: response.data.message || "Payment schedule created successfully"
      };
    } catch (error) {
      console.error("Error creating payment schedule:", error);
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to create payment schedule"
      };
    }
  },
   ...
   * @returns {Promise<Object>} API response
   */
  async generateMonthlyPaymentSchedule(contractData) {
    try {
      const response = await api.post("/financial/payment-schedules/generate-monthly", contractData);
      return {
        success: true,
        data: response.data.data || [],
        count: response.data.count || 0,
        message: response.data.message || "Monthly payment schedule generated successfully"
      };
    } catch (error) {
      console.error("Error generating monthly payment schedule:", error);
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to generate monthly payment schedule"
      };
    }
  },

  /**
   * Generate security deposit schedule
   * @param {Object} contractData - Contract data
   * @returns {Promise<Object>} API response
   */
  async generateDepositSchedule(contractData) {
    try {
      const response = await api.post("/financial/payment-schedules/generate-deposit", contractData);
      return {
        success: true,
        data: response.data.data || {},
        message: response.data.message || "Security deposit schedule generated successfully"
      };
    } catch (error) {
      console.error("Error generating deposit schedule:", error);
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to generate deposit schedule"
      };
    }
  },
   ...
   * @returns {Promise<Object>} API response
   */
  async updatePaymentScheduleStatus(scheduleId, statusData) {
    try {
      const response = await api.put(`/financial/payment-schedules/${scheduleId}/status`, statusData);
      return {
        success: true,
        data: response.data.data || {},
        message: response.data.message || "Payment schedule status updated successfully"
      };
    } catch (error) {
      console.error("Error updating payment schedule status:", error);
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to update payment schedule status"
      };
    }
  },
  ...
  async getOverduePayments() {
    try {
      const response = await api.get("/financial/payment-schedules/overdue");
      return {
        success: true,
        data: response.data.data || [],
        count: response.data.count || 0
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch overdue payments",
        data: []
      };
    }
  },
  ...
  async getUpcomingPayments(days = 7) {
    try {
      const response = await api.get("/financial/payment-schedules/upcoming", { params: { days } });
      return {
        success: true,
        data: response.data.data || [],
        count: response.data.count || 0
      ...
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch upcoming payments",
        data: []
      };
    }
  },
   ...
   * @returns {Promise<Object>} API response
   */
  async getPaymentScheduleStatistics(params = {}) {
    try {
      const response = await api.get("/financial/payment-schedules/statistics", { params });
      return {
        success: true,
        data: response.data.data || {}
      };
    } catch (error) {
      console.error("Error fetching payment schedule statistics:", error);
      return {
        success: false,
        error: error.response?.data?.error || error.message || "Failed to fetch payment schedule statistics",
        data: {}
      };
    }
  },
