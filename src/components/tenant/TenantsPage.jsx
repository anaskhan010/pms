...
const TenantsPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const tenantData = {
      ...
      password: 'Tenant123!', // Default password for tenant accounts
      ...
      apartmentId: formData.selectedApartment || null, // Use the apartment ID directly
      contractStartDate: formData.contractStart || null,
      contractEndDate: formData.contractEnd || null,
      securityFee: selectedApartment?.rent_amount ? selectedApartment.rent_amount * 2 : 0,
      ejariDocument: formData.ejariDocument || null
    };
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-slate-300 text-sm mt-1">
                    Create a new tenant profile with property assignment
                  </p>
                </div>
                <button
                  onClick={() => {
