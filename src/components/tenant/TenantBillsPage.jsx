  ...
  const columns = [
    {
      ...
      render: (_, bill) => (
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="text-sm font-medium text-gray-900 capitalize">{bill.bill_type}</div>
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Bills & Utilities</h1>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-amber-700 mt-1">
                You have SAR {totalPending} in pending utility bills. Pay them before the due date to avoid late fees.
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card header="Electricity (DEWA)" className="bg-gradient-to-br from-yellow-50 to-amber-50">
        ...
        <Card header="Water (DEWA)" className="bg-gradient-to-br from-blue-50 to-cyan-50">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Current Month</span>
        ...
        <Card header="Internet (Etisalat)" className="bg-gradient-to-br from-purple-50 to-indigo-50">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Current Month</span>
