        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <div className="text-sm text-blue-700 space-y-3">
              ...
              <div>
                <p>
                  <strong>Property Owner Access:</strong>
                </p>
                <p>
                  Email:{" "}
                  <code className="bg-blue-100 px-1 rounded">
                ...
                <p>
                  Password:{" "}
                  <code className="bg-blue-100 px-1 rounded">owner123</code>
                </p>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="mt-1 text-xs bg-green-600 text-white px-2 py-1 rounded hover:bg-green-700 transition-colors"
                >
                  Auto-fill Owner
                </button>
              </div>
