...
export const ManagerAndAbove = ({ children, fallback = null }) => (
  <RoleGuard roles={['admin', 'super_admin', 'manager']} fallback={fallback}>
    {children}
  </RoleGuard>
);

/**
 * Component for owner and above content
 */
export const OwnerAndAbove = ({ children, fallback = null }) => (
  <RoleGuard roles={['admin', 'super_admin', 'manager', 'owner']} fallback={fallback}>
    {children}
  </RoleGuard>
);
