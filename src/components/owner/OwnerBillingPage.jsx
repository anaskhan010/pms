...
const OwnerBillingPage = () => {
  ...
  const generateInvoiceNumber = (tenantId, month) => {
    const monthYear = new Date(month).toISOString().slice(0, 7).replace('-', '');
  ...
  const totalBilling = filteredTenants.reduce((sum, tenant) => sum + (tenant.monthly_rent || 0), 0);
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      {/* Filters */}
      <Card header="Filter Billing Records">
      ...
      <Card header="Payment Collection Progress">
        <div className="space-y-4">
          <div className="flex justify-between text-sm">
            ...
            <span>{Math.round((paidAmount / totalBilling) * 100) || 0}% Complete</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 text-center text-sm">
            <div>
              ...
              <div className="text-gray-500">SAR {paidAmount.toLocaleString()}</div>
            </div>
            <div>
              <div className="font-medium text-amber-600">Pending</div>
              <div className="text-gray-500">SAR {pendingAmount.toLocaleString()}</div>
            </div>
            <div>
              <div className="font-medium text-red-600">Overdue</div>
              <div className="text-gray-500">SAR {overdueAmount.toLocaleString()}</div>
            </div>
          </div>
        </div>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card header="Billing Actions" className="bg-gradient-to-br from-teal-50 to-blue-50">
        ...
        <Card header="Payment Tracking" className="bg-gradient-to-br from-emerald-50 to-green-50">
          <div className="space-y-3">
            <Button variant="primary" fullWidth>
              Record Payment
            </Button>
        ...
        <Card header="Reports & Analytics" className="bg-gradient-to-br from-purple-50 to-indigo-50">
          <div className="space-y-3">
            <Button variant="primary" fullWidth>
              Monthly Report
            </Button>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-emerald-50 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-sm font-medium text-gray-900">Sarah Al-Mansouri</div>
                <div className="text-sm text-gray-500">Sunset Villa - February 2024</div>
              </div>
            </div>
            <div className="text-right">
              <div className="text-sm font-medium text-emerald-600">SAR 8,500</div>
          ...
          <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-sm font-medium text-gray-900">Mohammed Al-Ahmed</div>
                <div className="text-sm text-gray-500">Al-Noor Complex - February 2024</div>
              </div>
            </div>
            <div className="text-right">
