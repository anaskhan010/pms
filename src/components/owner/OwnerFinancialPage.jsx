...
const OwnerFinancialPage = () => {
  ...
  const totalYearlyIncome = monthlyData.reduce((sum, month) => sum + month.income, 0);
  const totalYearlyExpenses = monthlyData.reduce((sum, month) => sum + month.expenses, 0);
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="text-center bg-gradient-to-br from-purple-50 to-pink-50">
          ...
          <div className="text-xs text-purple-600 mt-1">+15.3% vs last year</div>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card header="Generate Reports" className="bg-gradient-to-br from-blue-50 to-indigo-50">
        ...
        <Card header="Financial Actions" className="bg-gradient-to-br from-emerald-50 to-green-50">
          <div className="space-y-3">
            <Button variant="primary" fullWidth>
              Record Expense
            </Button>
        ...
        <Card header="Analysis Tools" className="bg-gradient-to-br from-purple-50 to-pink-50">
          <div className="space-y-3">
            <Button variant="primary" fullWidth>
              ROI Calculator
            </Button>
