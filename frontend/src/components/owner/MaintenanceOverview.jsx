...
const MaintenanceOverview = ({
  ...
  const stats = {
    ...
    pending_maintenance: maintenance.filter((m) => m.status === "pending")
      .length,
    in_progress_maintenance: maintenance.filter(
      (m) => m.status === "in_progress"
    ).length,
    total_complaints: complaints.length,
    open_complaints: complaints.filter((c) => c.status === "open").length,
    resolved_complaints: complaints.filter((c) => c.status === "resolved")
      .length,
  };
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          {!loading && (
            <div className="mt-2 text-sm text-blue-600">
              ...
              {stats.in_progress_maintenance} in progress
            </div>
          )}
        </div>
            ...
            <div className="text-purple-600">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M8 12V9a4 4 0 118 0m-4 8a4 4 0 01-4-4V9a4 4 0 118 0v3m-4 8c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4z"
                />
              </svg>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500">
              No maintenance requests or complaints
            </p>
          </div>
        ) : (
          <div className="space-y-3">
