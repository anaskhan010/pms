...
const OccupancyChart = ({ occupied, vacant, loading = false }) => {
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-gray-900">
              {occupied} <span className="text-sm text-gray-500">units</span>
            </p>
          </div>
        </div>
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-gray-900">
              {vacant} <span className="text-sm text-gray-500">units</span>
            </p>
          </div>
        </div>
      </div>
