...
const TenantDocumentsPage = () => {
  ...
  // Memoized filtered documents to prevent unnecessary re-renders
  ...
  const documentsByType = useMemo(() => {
    return {
      ejari_certificate: filteredDocuments.filter(
        (d) => d.document_type === "ejari_certificate"
      ),
      lease_agreement: filteredDocuments.filter(
        (d) => d.document_type === "lease_agreement"
      ),
      receipts: filteredDocuments.filter(
        (d) => d.document_type === "security_deposit_receipt"
      ),
      other: filteredDocuments.filter(
        (d) =>
          ![
            "ejari_certificate",
            "lease_agreement",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6 bg-emerald-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Renew your Ejari certificate online
            </p>
