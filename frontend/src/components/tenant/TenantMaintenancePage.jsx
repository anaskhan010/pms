...
const TenantMaintenancePage = () => {
  ...
  const handleSubmitRequest = async (e) => {
    e.preventDefault();
    try {
      const response = await tenantDataService.submitMaintenanceRequest(
        user?.id,
        {
          ...newRequest,
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, request) => (
        <div className="text-sm text-gray-900">
          {request.assigned_vendor || "Not assigned"}
        </div>
      ),
    },
    {
            ...
            <form onSubmit={handleSubmitRequest} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={useCallback(
                    (e) =>
                      setNewRequest((prev) => ({
                        ...prev,
                        tenant_available: e.target.value,
                      })),
                    []
                  )}
                  className="w-full bg-white text-black rounded-md border border-gray-400 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-black"
                >
                  ...
                  <option value="weekdays_afternoon">
                    Weekdays Afternoon (12PM-5PM)
                  </option>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-red-700 mt-1">
                For urgent issues like water leaks, electrical hazards, or
                security concerns, contact the emergency hotline immediately.
              </p>
              <div className="mt-3">
                <a
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-start space-x-2">
                ...
                <span>
                  Check if the issue is covered by your lease agreement
                </span>
              </li>
              <li className="flex items-start space-x-2">
                <svg
